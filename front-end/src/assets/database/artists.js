...
export const artistsArray = await getArtists();
  
export const artistsIndexedById = artistsArray.reduce((acc, currentObj) => {
  acc[currentObj._id] = currentObj;
  return acc;
}, {});

export const artistsIndexedByName = artistsArray.reduce((acc, currentObj) => {
